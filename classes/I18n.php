...
class I18n extends \Kohana\Core\I18n {
	...
	public static function load($lang)
	{
		...
		$filename = \Kohana::$cache_dir . DIRECTORY_SEPARATOR . implode(DIRECTORY_SEPARATOR, ['i18n', NULL]) . $lang . '.js';
	...
	public static function detect_lang()
	{
		...
		return static::normalize_lang_key($lang);
	}
	...
	public static function available_langs()
	{
		...
		{
			$_langs[static::normalize_lang_key($lang)] = __($name);
		}
