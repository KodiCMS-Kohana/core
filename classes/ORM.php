...
class ORM extends \Kohana_ORM {
	...
	public function field($field, array $attributes = NULL)
	{
		...
		{
			$input = Callback::invoke_function($field_data['type'], [$this, $field, $attributes]);
		}
		else
		{
	...
	public function get_related_ids($alias)
	{
		...
		{
			throw new Exception('Relation :alias not exists in object :object', [
				':alias' => $alias,
